...
| severity_factor | int [DEFAULT=100] | Effect of flight profile on engine degradation in % | 90 |

## Data Generator

You see a list of operators belonging to Lufthansa Group. Find web resources about the aircraft types each of the operators is using. Ignore airctaft types which are not in the list given in this prompt. Generate two or three three sample aircraft per each combination of operator and aircraft type. Use realistic German registrations (D-AXXX pattern) and MSN numbers.
